...
export default function RestaurantDetail() {
  ...
  if (!restaurant)
    return (
      <div className="p-8 text-center text-stone-400">Restaurant not found</div>
    );
    ...
    <div className="page-enter">
      ...
      <div className="relative h-56 md:h-72 overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 right-0 p-6 text-white">
          <h1 className="font-display font-bold text-3xl drop-shadow">
            {restaurant.name}
          </h1>
      ...
      <div className="bg-white dark:bg-stone-900 border-b border-stone-100 dark:border-stone-800 px-4 py-4">
        <div className="max-w-5xl mx-auto flex flex-wrap items-center gap-5 text-sm text-stone-600 dark:text-stone-400">
          ...
          <span className="flex items-center gap-1">
            <HiClock className="w-4 h-4" /> {restaurant.deliveryTime}
          </span>
          <span className="flex items-center gap-1">
            {formatCurrency(restaurant.costForTwo)} for two
          </span>
          <span
            className={`font-semibold ${restaurant.isOpen ? "text-emerald-500" : "text-stone-400"}`}
          >
